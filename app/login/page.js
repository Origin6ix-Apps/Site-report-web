...
import { ShieldCheck, Building2, HardHat, ChevronRight, Check } from "lucide-react";
...
const PORTALS = [
  {
    ...
    features: [
      "View every project, Admin, and Supervisor in one place",
      "Assign or change any role instantly — no waiting",
      "Track company-wide progress and material stock",
    ],
  },
  {
    ...
    features: [
      "Create and manage projects, deadlines, and scope",
      "Assign Supervisors to sites in one click",
      "Track attendance, employees, and stock centrally",
    ],
  },
  {
    ...
    features: [
      ...
      "Mark attendance and manage your crew",
      "Order materials and track stock in real time",
    ],
  },
];
...
export default function LoginPage() {
  ...
  return (
    <div className="split-screen">
      {portal === null ? <PortalPicker onChoose={setPortal} /> : <PortalLogin portal={portal} onBack={() => setPortal(null)} />}
    </div>
  );
}
